...
import { CheckInOutSettings } from '@/components/admin/checkin-out-settings';
import { Button } from '@/components/ui/button';
import { ChevronLeft } from 'lucide-react';

export const dynamic = 'force-dynamic';

export default async function CheckInOutSettingsPage() {
  ...
  return (
    <div className="p-6 max-w-3xl">
      ...
      <CheckInOutSettings tenant={tenant} />
    </div>
  );
}
